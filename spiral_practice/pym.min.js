!(function(a) {
  ...
  var a = "xPYMx",
    ...
    d = function(a, b) {
      return "*" === b.xdomain || a.origin.match(new RegExp(b.xdomain + "$"))
        ? !0
        : void 0;
    },
    e = function(b, c, d) {
    ...
    g = function() {
      for (
        ...
        var f = e.getAttribute("data-pym-src"),
          g = e.getAttribute("data-pym-xdomain"),
          h = {};
  ...
  return (
      ...
      (this.id = a),
        ...
        (this._constructIframe = function() {
          ...
          var b = "",
            c = this.url.indexOf("#");
          c > -1 &&
            ((b = this.url.substring(c, this.url.length)),
        ...
        (this.sendMessage = function(a, b) {
          this.el
            ...
            .contentWindow.postMessage(e(this.id, a, b), "*");
        }),
    ...
    (b.Child = function(b) {
      (this.parentWidth = null),
        (this.id = null),
        (this.parentUrl = null),
        (this.settings = { renderCallback: null, xdomain: "*", polling: 0 }),
